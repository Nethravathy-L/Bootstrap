               ...
               <!--<li><a id="#" href="#expertModal" data-toggle="modal" data-target="#expertModal" class="head_panel" style="font-size:14px">Industry Expert</a></li>-->
                ...
                <li><a href="http://onlineinternship.suvenconsultants.com"  style="cursor:pointer;font-size:18px"><span class="glyphicon glyphicon-home"></span></a></li>
                            ...
                            <div class="inset" class="dropdown-toggle" data-toggle="dropdown"><img src="images/users/default-user.png" 
                                class="img-responsive" data-toggle="tooltip" title="Nethravathy L &#010;nethravathy1999@gmail.com" style="cursor:pointer;"></div>
                            <ul class="dropdown-menu hidden-sm hidden-xs" style="padding:5px;">
                                <li class="text-center"><p><b>Nethravathy L </b></p>
                                <p>nethravathy1999@gmail.com</p></li>
                                <a href="profile.php?userID=12788" class="btn btn-info btn-sm center-block">Profile</a>
                                <li class="divider"></li>
                            ...
                            <ul class="dropdown-menu hidden-lg hidden-md" style="padding:5px;">
                                <a href="profile.php?userID=12788" class="btn btn-info btn-sm">Profile</a>&nbsp;&nbsp;<a href="logout.php" class="btn btn-danger btn-sm">Logout</a>
                            </ul></li>              </ul>
            </div>
          </div>
        </nav>
    ...
    <div class="modal-dialog modal-smll" role="modal">
        <div class="modal-content">
            <div class="modal-header text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span class="badge" style="background-color:#000;">Ã—</span></button>
